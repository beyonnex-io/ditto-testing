...
public final class PolicyEntryImportReferencesIT extends IntegrationTest {
    ...
    public void secondUserGainsThingAccessViaImportReference() {
        ...
        createTemplatePolicy(templatePolicyId, Set.of(AllowedImportAddition.SUBJECTS));
    ...
    // ---- allowedImportAdditions enforcement ----
    ...
    public void importRefWithResourceAdditionsAllowed() {
        createTemplatePolicy(templatePolicyId, Set.of(AllowedImportAddition.RESOURCES));

        // Entry with extra resource + import reference
    ...
    public void reducingAllowedImportAdditionsRevokesResourceAdditionEffect() {
        ...
        // Reduce allowedImportAdditions: remove RESOURCES
